...
export const initialBoard: Board = [
  ...
  { position: { x: { name: "d", value: 4 }, y: { name: "8", value: 8 } }, piece: { name: "King", type: "king", side: "black", imageUrl: "/pieces/king/black.svg", hasEverMoved: false } },
  { position: { x: { name: "e", value: 5 }, y: { name: "8", value: 8 } }, piece: { name: "Queen", type: "queen", side: "black", imageUrl: "/pieces/queen/black.svg", hasEverMoved: false } },
  ...
  { position: { x: { name: "d", value: 4 }, y: { name: "1", value: 1 } }, piece: { name: "King", type: "king", side: "white", imageUrl: "/pieces/king/white.svg", hasEverMoved: false } },
  { position: { x: { name: "e", value: 5 }, y: { name: "1", value: 1 } }, piece: { name: "Queen", type: "queen", side: "white", imageUrl: "/pieces/queen/white.svg", hasEverMoved: false } },
